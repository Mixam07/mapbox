                ...
                <form onSubmit={formik.handleSubmit} className="flex w-full gap-y-4 flex-col">
                    <div>
                        <div className="w-full relative">
                            ...
                            <input className={`w-full bg-gradient-to-l from-500 to-500/75 rounded-2xl text-200 font-bold pt-10 pr-14 pb-4 pl-6
                                placeholder:text-200/60 border-[1px] border-solid ${formik.errors.username? "border-600": "border-600/0"}`} type="text" placeholder="Enter your username" id="username" name="username"
                    ...
                    <div className="flex gap-x-2">
                        <div>
                            <div className="w-full relative">
                                ...
                                <input className={`w-full bg-gradient-to-l from-500 to-500/75 rounded-2xl text-200 font-bold pt-10 pr-14 pb-4 pl-6
                                placeholder:text-200/60 border-[1px] border-solid ${formik.errors.first_name? "border-600": "border-600/0"}`} placeholder="Enter your first name" id="first_name" name="first_name"
                        ...
                        <div>
                            <div className="w-full relative">
                                ...
                                <input className={`w-full bg-gradient-to-l from-500 to-500/75 rounded-2xl text-200 font-bold pt-10 pr-14 pb-4 pl-6
                                placeholder:text-200/60 border-[1px] border-solid ${formik.errors.last_name? "border-600": "border-600/0"}`} type="text" placeholder="Enter your last name" id="last_name" name="last_name"
                    ...
                    <div>
                        <div className="w-full relative">
                            ...
                            <input className={`w-full bg-gradient-to-l from-500 to-500/75 rounded-2xl text-200 font-bold pt-10 pr-14 pb-4 pl-6
                                placeholder:text-200/60 border-[1px] border-solid ${formik.errors.email? "border-600": "border-600/0"}`} type="email" placeholder="Enter your email" id="email" name="email"
                    ...
                    <div>
                        <div className="w-full relative">
                            ...
                            <input className={`w-full bg-gradient-to-l from-500 to-500/75 rounded-2xl text-200 font-bold pt-10 pr-14 pb-4 pl-6
                                placeholder:text-200/60 border-[1px] border-solid ${formik.errors.password? "border-600": "border-600/0"}`} type="password" placeholder="****************" id="password" name="password"
